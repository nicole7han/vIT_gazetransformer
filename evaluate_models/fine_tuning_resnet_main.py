...
anno_path = "{}/data/annotations".format(basepath)
test_img_path = "{}/data/test".format(basepath)
test_bbx_path = "{}/data/test_bbox".format(basepath)
fig_path = '{}/model_eval_outputs_small/resnet_epoch{}_eval_outputs'.format(basepath, epoch)
criterion = nn.BCELoss(reduction='mean')
chong_est = pd.read_excel('{}/data/Chong_estimation_test.xlsx'.format(basepath))
output = evaluate_test(anno_path, test_img_path, test_bbx_path, chong_est, criterion,  model, fig_path)
output.to_excel('{}/model_eval_outputs_small/transformer_epoch{}_result.xlsx'.format(basepath, epoch))
