...
parser.add_argument('--image_dir', type=str, help='images', default='images/61.mp4_Frames')
parser.add_argument('--head', type=str, help='head bounding boxes', default='images/61.mp4.txt')
...
def run():
    ...
    with torch.no_grad():
        for i in df.index:
            ...
            # frame_head = cv2.rectangle(np.array(frame_raw), (head_box[0], head_box[1]), (head_box[2], head_box[3]), [1, 1, 1], 4)
            ...
            plt.savefig('images/output/{}.png'.format(i), bbox_inches='tight')
